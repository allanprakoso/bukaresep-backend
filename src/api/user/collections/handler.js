...
class CollectionsHandler {
    ...
    async updateCollectionHandler(request, h) {
        ...
        const collection = await this.service.updateCollection({ collection_id, user_id: credentialId }, request.payload);
        const response = h.response({
            status: 'success',
    ...
    async addRecipeToCollectionHandler(request, h) {
        ...
        await this.service.addRecipeToCollection({ collection_id, recipe_id, user_id: credentialId });
        const response = h.response({
            status: 'success',
    ...
    async deleteRecipeFromCollectionHandler(request, h) {
        ...
        await this.service.removeRecipeFromCollection({ collection_id, recipe_id, user_id: credentialId });
        const response = h.response({
            status: 'success',
